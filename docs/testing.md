...
dager. Legger du til tester, er det denne fila som skal rettes.
    ...
    node test/unit.mjs      874 tester, ~90 ms, ingen nettleser
    node test/funksjon.mjs  439 tester, ~250 ms, ingen nettleser
    node test/run.mjs       942 tester, 3–20 s, headless Chromium
