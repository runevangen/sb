...
dager. Legger du til tester, er det denne fila som skal rettes.
    ...
    node test/unit.mjs      667 tester, ~90 ms, ingen nettleser
    node test/funksjon.mjs  372 tester, ~250 ms, ingen nettleser
    node test/run.mjs       592 tester, 3–20 s, headless Chromium
