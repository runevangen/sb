...
dager. Legger du til tester, er det denne fila som skal rettes.
    ...
    node test/unit.mjs      885 tester, ~90 ms, ingen nettleser
    node test/funksjon.mjs  450 tester, ~250 ms, ingen nettleser
    node test/run.mjs       946 tester, 3–20 s, headless Chromium
